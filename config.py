...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001959163481"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001932915263"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1487384337").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "FILE : {file_name}\n\nSize : {file_size}\n\n✅Powered By @shortnfly")
